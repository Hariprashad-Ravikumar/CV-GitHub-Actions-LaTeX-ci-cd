...
\vspace{-0.3em}
\begin{enumerate}
    \item Incoming \textbf{Modeling and Simulation Intern}, Western Digital, San Jose, CA \hfill \textit{(May 2026 - Aug 2026)}
%\vspace{-0.2em}
...
\begin{enumerate}[leftmargin=1.5em]
    \item C.-R. Ji and \textbf{H. Ravikumar}, \textit{"Interpolating conformal algebra in (1+1) dimensions between the instant form and the light-front form of relativistic dynamics,"} \textbf{Physical Review D} (March 2026). DOI: \href{https://doi.org/10.1103/prlq-4j1l}{10.1103/prlq-4j1l}.
