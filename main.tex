...
\begin{center}
  ...
  %Expertise in Python, Machine Learning, and Full-Stack Data Science Applications
...
\vspace{-0.3em}
\begin{enumerate}
        \item \textbf{Media Test Engineering Intern (HAMR Modeling \& Simulation)}, Western Digital, San Jose, CA \hfill \textit{(May 2026 -- Aug 2026)}
    \vspace{-0.5em}
    \begin{itemize}
